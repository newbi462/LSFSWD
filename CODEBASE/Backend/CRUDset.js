//FOR BEST PRACTICE ALL KNEX DB logic should be exported to a modles file and done by way of middle where helperfuntions

const express = require('express');

const db = require('./../data/db.js');
const CarsModel = require('./CRUD_ModelImports.js');
